...
--- Plugin homepage
PLUGIN.homepage = "https://github.com/ShizheChang/vfox-kotlin"
...
NOTE:
 ...
 --]]
PLUGIN.manifestUrl = "https://github.com/ShizheChang/vfox-kotlin/releases/download/manifest/manifest.json"
